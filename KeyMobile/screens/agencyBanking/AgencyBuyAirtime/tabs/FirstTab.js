          ...
          return(
            <View style={{paddingHorizontal:20,paddingBottom:20,flex:1}}>
              ...
              <Input
                  ...
                  icon={<FontAwesome5 name="address-book" size={16} color={COLORS.grey} />}
              ...
              {/* <DropDownInput
                  data={[{label:'Airtel',value:'Airtel'},{label:'Etisalat',value:'Etisalat'}]}
                  labelCustomStyle={styles.inputLabel}
                  labelField="label"
                  valueField="value"
                  placeholder="Select Customer's Network"
                  value={customerNetwork}
                  onFocus={() => setCustomerNetworkFocus(true)}
                  onBlur={() => setCustomerNetworkFocus(false)}
                  onChange={item => {
                    setCustomerNetwork(item.value);
                    setCustomerNetworkFocus(false)
                    }}
                ...
                <View style={{flexDirection:'row',justifyContent:'space-between'}}>
                  <Text style={{color: COLORS.primaryBlue}}>Save to Bill list</Text>
                  <ToggleSwitch
