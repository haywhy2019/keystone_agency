...
const FirstTab = () => {
  ...
  const [transferTypeModal, setTransferTypeModal]= useState(false);
  ...
  return (
    ...
    >
        ...
        {({
          ...
          return(
            <View style={{paddingHorizontal:20,paddingBottom:20,flex:1}}>
              ...
              <TouchableOpacity
                style={styles.transferStyle}
                onPress={()=>setTransferTypeModal(true)}
              >
                <Text style={{color:COLORS.grey}}>Transfer Type</Text>
                <Ionicons name="ios-chevron-down" size={21} color={COLORS.grey} />
              </TouchableOpacity>
      ...
      <Modal
        visible={transferTypeModal}
      >
        <View style={{paddingVertical:30}}>
          <Text style={[GLOBAL_STYLE.h2Bold,{textAlign:'center'}]}>Transfer Types</Text>
          <MenuImageLeftIconRight
            leftIcon={<AntDesign name="user" size={17} color="black" />}
            label={'Transfer to e-naira'}
            onPress={()=>setTransferTypeModal(false)}
          />
          <MenuImageLeftIconRight
            leftIcon={
              <Image
