...
import { COLORS, GLOBAL_STYLE, FONTS } from "../../../constants";
...
const Investments = () => {
  ...
  return (
    ...
    //       <View
    //         style={[
    //           GLOBAL_STYLE.rowAround,
    //          styles.activeAndInactiveContainer
    //         ]}
    //       >
    //         <CustomButton
    //           buttonText={"New"}
    //           buttonContainerStyle={
    //             isNew ? styles.activeButton : styles.inactiveButton
    //           }
    //           buttonTextStyle={
    //             isNew ? styles.textWhite : styles.textBlue
    //           }
    ...
    //           buttonText={"Existing"}
    //           buttonTextStyle={
    //             isNew ? styles.textBlue : styles.textWhite
    //           }
    //           onPress={() => setIsNew(false)}
    //           buttonContainerStyle={
    //             isNew ? styles.inactiveButton : styles.activeButton
    //           }
    //         />
    //       </View>
    //     </View>
    //     {isNew ? <NewInvestment /> : <ExistingInvestment />}
    //   </View>
    // </ScrollView>
    <TabView
