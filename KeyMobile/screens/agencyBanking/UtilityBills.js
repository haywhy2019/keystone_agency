        ...
        {({
          ...
          return(
            <View style={{paddingHorizontal:20,paddingBottom:20,flex:1}}>
                <DropDownInput
                  data={[{label:'IKEDEC',value:'IKEDEC'},{label:'WATER ',value:'WATER'}]}
                ...
                <Input
                  placeholder={'Enter Customer\'s Meter Number'}
                  placeholderTextColor={COLORS.grey}
                  inputCustomStyle={{borderWidth:0.3}}
                  icon={null}
                  value={values.meterNum}
                  onChangeText={handleChange('meterNum')}
                  keyboardType='numeric'
                  onBlur={handleBlur('meterNum')}
                  error={ errors.meterNum}
                />
